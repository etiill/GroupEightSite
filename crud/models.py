...
class Genders(models.Model):
    ...
    gender_id = models.BigAutoField(primary_key=True, blank=False) #gender_id BIGINT NOT NULL AUTO-INCREMENT PRIMARY KEY
    ...
    updated_at = models.DateTimeField(auto_now=True) # update_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
